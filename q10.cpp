...
//CS-G
//Assignment # 1
//Question # 10 (Only by ternary operator)
...
int main(){
    ...
    //Ask the user to enter numbers(within grid range)
    ...
    &&
    (second_num == n2 || second_num == n11 || second_num == n13 || second_num == n18 || second_num == n19 || second_num == n24 || second_num==n29 || 
    second_num==n32)) 
    ...
    &&
    (second_num == n3 || second_num == n10 || second_num == n14 || second_num == n23 || second_num == n25 | second_num == n30 || second_num==n31 ||      
    second_num==n36))
