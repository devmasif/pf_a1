...
using namespace std;
int main(){
//Variable declaration (Unsigned use for 32 bit input)
...
//right shift n by 8 and set bitset to 8 to get gate 2
n1=(n>>8);
cout<<" Gate 2 = "<<bitset<8>(n1)<<"\n\n";

//right shift n by 16 and set bitset to 8 to get gate 3
n2=(n>>16);
cout<<" Gate 3 = "<<bitset<8>(n2)<<"\n\n";

//right shift n by 24 and set bitset to 8 to get public constant
n3=(n>>24);
